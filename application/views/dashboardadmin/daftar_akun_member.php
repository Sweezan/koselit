          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Akun Member</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <a href="<?php echo base_url('index.php/member/tambahakun_member') ?>">+ Tambah Akun Member</a>
              ...
              <a href="<?php echo site_url('member/delete_akun/'.$val->id);?>" onclick="return confirm('Yakin Akan Hapus Data Ini?')" class="btn btn-danger">Hapus</a>
              </div></td>
                    </tr>
          <?php $no++; } ?>
                  </tbody>
