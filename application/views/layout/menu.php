    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li clas="nav-item">
          <a href="<?php echo site_url('welcome/dashboard_admin'); ?>" class="nav-link">
         ...
         <li clas="nav-item">
          ...
          <p>Member</p>
             ...
             <li clas="nav-item">
          <a href="<?php echo site_url('cs/daftar_cs'); ?>" class="nav-link">
          <i class="nav-icon fas fa-th"></i>  
         ...
         <li clas="nav-item">
          <a href="<?php echo site_url('welcome/bukti_bayar') ?>" class="nav-link">
          <i class="nav-icon fas fa-user"></i>  
          <p>Bukti Transaksi</p>
          </a>
         </li>
         <li clas="nav-item">
          <a href="<?php echo site_url('member/daftar_akun_member'); ?>" class="nav-link">
          <i class="nav-icon fas fa-user"></i>  
          <p>akun member</p>
          </a>
         </li>
